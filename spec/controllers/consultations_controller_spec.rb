  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved consultation as @consultation" do
        ...
        post :create, {:consultation => { "provider" => "invalid value" }}, valid_session
        assigns(:consultation).should be_a_new(Consultation)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested consultation" do
        ...
        Consultation.any_instance.should_receive(:update_attributes).with({ "provider" => "MyString" })
        put :update, {:id => consultation.to_param, :consultation => { "provider" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the consultation as @consultation" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Consultation.any_instance.stub(:save).and_return(false)
        put :update, {:id => consultation.to_param, :consultation => { "provider" => "invalid value" }}, valid_session
        assigns(:consultation).should eq(consultation)
      end
